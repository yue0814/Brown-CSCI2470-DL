...
b1 = tf.Variable(tf.random_uniform([8], dtype=tf.float32))
...
print("After 3 different trials, the mean reward collected for the last 100 episodes is %d" % (sum(totOutput)/3))
